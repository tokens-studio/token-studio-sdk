...
export type RawToken = Raw_Token_border | Raw_Token_boxShadow | Raw_Token_color | Raw_Token_scalar | Raw_Token_typography
...
export type Token = Token_border | Token_boxShadow | Token_color | Token_scalar | Token_typography
