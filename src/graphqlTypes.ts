...
export type RawToken = Raw_Token_color | Raw_Token_scalar | Raw_Token_typography | Raw_Token_border | Raw_Token_boxShadow
...
export type Token = Token_color | Token_scalar | Token_typography | Token_border | Token_boxShadow
