...
import { TokenInput as GraphqlTokenInput, TokenType, CreateTokenMutationVariables, CreateTokenMutation } from '../graphqlTypes';
...
export namespace Mutation {
    ...
    export const createToken = async (set: string, token: TokenInput) => {
        return await Graphql.exec<CreateTokenMutation>(Graphql.op(
